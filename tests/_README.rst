...
If you are reading this, you're interested in contributing to django-idmap.
Great news!
...
django-idmap uses nose_ and django_nose_ for testing. All the tests are in the
...
django-idmap uses zc.buildout_ to generate tests scripts. In (very) short
...
django-idmap also uses tox_ to test against various environments (mainly
